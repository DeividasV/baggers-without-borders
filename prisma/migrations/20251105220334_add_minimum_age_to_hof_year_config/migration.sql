...
INSERT INTO "new_hof_year_configs" ("createdAt", "hofId", "id", "lceEnabled", "lceMinFpr", "minForeignPeaks", "minFpr", "minPeaks", "notes", "updatedAt", "yearId") SELECT "createdAt", "hofId", "id", "lceEnabled", "lceMinFpr", "minForeignPeaks", "minFpr", "minPeaks", "notes", "updatedAt", "yearId" FROM "hof_year_configs";
