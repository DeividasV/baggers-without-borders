...
INSERT INTO "new_leagues" ("code", "createdAt", "description", "id", "isActive", "minAltitude", "minClimbs", "minIsolation", "minProminence", "title", "updatedAt") SELECT "code", "createdAt", "description", "id", "isActive", "minAltitude", "minClimbs", "minIsolation", "minProminence", "title", "updatedAt" FROM "leagues";
DROP TABLE "leagues";
